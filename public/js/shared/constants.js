 ...
 *
 * NOTE: If you modify these values, also update functions/shared/constants.js
 */

// Auction timing
export const FLOOR_TIMER_DURATION = 60; // seconds at floor before auction ends
 ...
 */
export function getSteepnessLabel(value) {
 ...
 */
export function getSteepnessDescription(value) {
...
export const ALGORITHMIC_DEFAULTS = {
  BASE_DECAY: 0.001,
