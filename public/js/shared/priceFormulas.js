 ...
 *
 * CRITICAL: This file must stay in sync with functions/shared/priceFormulas.js
 * Any changes here MUST be mirrored to the server version to prevent
 ...
 */
export function calculateTransparentPrice(params, elapsedSeconds) {
 ...
 */
export function calculateLinearPrice(startingPrice, floorPrice, duration, elapsedSeconds) {
 ...
 * @returns {number} Price in cents
 */
export function calculateExponentialPrice(startingPrice, floorPrice, decayRate, elapsedSeconds) {
 ...
 * @returns {number} Price in cents
 */
export function calculateSteppedPrice(startingPrice, floorPrice, duration, config, elapsedSeconds) {
 ...
 */
export function calculateExpDecayRate(steepness, startingPrice, floorPrice, durationSeconds) {
 ...
 */
export function generatePreviewPoints(params, numPoints = 50) {
